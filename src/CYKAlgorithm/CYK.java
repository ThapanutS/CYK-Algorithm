...
public class CYK {
    ...
    public void cykAlgorithm(ScrollPane scrollpane, String[] character_split){
        ...
        cykTableCopy = cykTable; /// copy the cykTable for use check string accept cyk
    ...
    public static boolean acceptStringRandom(String startVarible){ //Check String accept CYK
